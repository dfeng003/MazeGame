...
//    private int trackerPort;
    ...
    public Game(String trackerIp, int trackerPort, String playerID, GameState gamestate) throws RemoteException, NotBoundException {
        super();
...
//        this.trackerPort = trackerPort;
        ...
        ////////GUI////////////////////
        mGui = new GUI(gameState, playerID);
        observable = new PropertyChangeSupport(this);
        observable.addPropertyChangeListener(mGui);
        ///////GUI/////////////////
    }
